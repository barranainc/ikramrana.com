...
Rule clarity: What proportion of cases follows defined rules, and what happens in the exceptions? There is no universal percentage that makes a process safe to automate.
...
const faqs = [
  ...
  { q: "What should businesses automate first?", a: "Automate the process that scores highest on four criteria: volume (how often it occurs), rule clarity (can the normal path follow defined rules consistently), error tolerance (how costly are mistakes), and integration feasibility (can the systems be connected). The intersection of high volume and high rule clarity is the ideal starting point." },
  ...
  { q: "What industries can use the AI Adoption Framework?", a: "The framework can be used to examine workflows in professional services, healthcare, financial services, legal, real estate, construction, logistics, consulting, and other settings. Industry alone does not determine benefit. The relevant factors are the workflow, data, rules, consequences, ownership, and operating context." },
        ...
        <div className="flex gap-10">
          ...
          <main className="flex-1 min-w-0">
            ...
            <section id="when-not" className="mb-14">
              ...
              {[
                { title: "PROCESSES TOO INCONSISTENT FOR DEFINED CONTROL", body: "If a process cannot be described with stable rules, known exceptions, and accountable escalation, it may be unsuitable for automation. There is no universal percentage threshold. The decision should reflect actual exception patterns and the consequences of error." },
            ...
            <section id="expert" className="mb-14">
              ...
              <p className="text-slate-text leading-relaxed mb-4 font-sans text-[15px]">Ikram Rana developed the AI Adoption Framework to organize his practical work on process clarity, automation, decision support, governance, and optimization. It is a methodology for examining implementation choices, not independent proof that a specific solution will work or produce a particular result.</p>
