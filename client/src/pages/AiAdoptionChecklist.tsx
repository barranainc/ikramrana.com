...
const phases = [
  ...
  },
  {
    ...
    steps: [
      { num: "16", title: "Define accuracy standards for each automation", detail: "Set a workflow-specific production threshold based on error consequences, review capacity, professional duties, contractual requirements, and remediation cost. Do not apply one universal accuracy percentage to every task." },
