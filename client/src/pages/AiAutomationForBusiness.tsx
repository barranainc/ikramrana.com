...
const faqs = [
  ...
  { q: "What is the ROI of AI automation?", a: "ROI should be measured from the business’s own baseline. Track total staff time, correction work, delays, missed follow-ups, operating cost, adoption, and customer impact before and after implementation. Include subscriptions, review time, maintenance, exceptions, and residual risk. There is no responsible universal savings range for every workflow." },
  ...
  { q: "How long does AI automation implementation take?", a: "The timeline depends on process clarity, data quality, integration access, security review, exception volume, testing, and staff adoption. A narrow workflow may move faster than a multi-system implementation, but the schedule should be defined only after discovery and should include stabilization after launch." },
  { q: "How much does AI automation cost for businesses?", a: "Cost depends on workflow scope, integrations, data, security, exception handling, testing, governance, training, and support. Barrana’s Discovery Stage is $1,500 CAD and is credited toward implementation if the client proceeds. The implementation scope and quote are prepared after discovery." },
      ...
      <div className="container py-14 max-w-4xl mx-auto">
        ...
        <section className="mb-14">
          ...
          {[
            ...
            { num: "05", title: "Measuring success by speed", desc: "A faster generation step can still create more work if it requires constant monitoring, correction, or reconciliation. Measure the complete workflow, including cognitive load, error remediation, adoption, and time recovered for higher-value work." },
          ].map((item, i) => (
