...
const typicalImpact = [
  "Less continuous manual handling",
        ...
        <motion.div {...fadeUp} className="mb-12">
          ...
          <div className="rounded-2xl border border-border bg-card p-7">
            <p className="text-foreground/85 leading-relaxed mb-5">
              Consider a hypothetical professional-services firm with inconsistent intake, repeated data entry, and manual follow-ups.
            </p>
            <p className="text-foreground/85 leading-relaxed mb-6">
              A possible design would standardize intake routing, add AI-assisted drafting with defined review checkpoints, and introduce escalation triggers.
            </p>
            <div>
              <span className="font-mono text-[10px] tracking-[0.15em] uppercase text-electric block mb-3">Measures to Establish</span>
              <ul className="space-y-2">
                {["Staff time spent on intake and follow-up", "Client response time before and after implementation", "Share of overrides recorded with an owner and reason"].map((r, i) => (
