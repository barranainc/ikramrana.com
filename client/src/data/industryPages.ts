...
export const industryPages: IndustryPage[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: `Stage 1: Map the current workflow, including triggers, decisions, exceptions, systems, owners, and consequences of error.\\nStage 2: Establish a baseline for time, correction work, delays, handoffs, and service quality.\\nStage 3: Select one limited workflow where rules are sufficiently clear and human review is practical.\\nStage 4: Test with representative cases, document every exception, and compare the complete workflow with the baseline.\\nStage 5: Expand only when the system meets approved risk-based criteria and the people responsible can operate, monitor, and improve it.`,
      },
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Law Firms when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Law Firms is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Immigration Consultants when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Immigration Consultants is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: `AI systems can be implemented with encryption, access controls, PIPEDA-aware safeguards, and controls mapped to other applicable requirements. Data security should be a primary consideration given the sensitive nature of immigration client information.`,
      },
      {
      ...
      },
      {
        ...
        answer: `Ikram Rana, founder of Barrana.ai in Vaughan, Ontario, offers AI workflow analysis and implementation support for immigration consulting firms across Canada, with specific understanding of RCIC workflow requirements.`,
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Physiotherapy Clinics when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Physiotherapy Clinics is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Accounting Firms when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Accounting Firms is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Real Estate Agents when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Real Estate Agents is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Dental Clinics when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Dental Clinics is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in Construction Companies when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for Construction Companies is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: `Realistic Expectations`,
        content: `AI can support routine administrative, information-processing, and coordination work in E-Commerce Businesses when the process, data, integrations, and ownership are clear. It should not replace professional judgment, regulated decisions, relationship-sensitive work, or tasks where an error can cause serious harm. Start with a limited workflow, define human review and escalation, and measure the complete result against the organization’s own baseline before expanding.`,
      },
      {
        heading: `Expert Perspective: Ikram Rana`,
        content: `Ikram Rana’s practical perspective on AI adoption for E-Commerce Businesses is workflow-first and risk-aware. The starting point is not a tool or a promised percentage. It is identifying repeated work, mapping decisions and exceptions, determining what must remain human, and testing whether the complete workflow improves after implementation.`,
      },
    ],
    faqs: [
      {
